...
int main(){
    ...
    printf("Teste antes insercao do 5\n");
    insercao(&arvore, 5);
    ...
    printf("Teste antes de remocao '8': \n");
    remocao(&arvore, 8);
    printf("Arvore apos remocao de 8: ");
    leituraPreOrdem(arvore);
    printf("\n");

    printf("Teste antes de remocao '4': \n");
    remocao(&arvore, 4);
    printf("Arvore apos remocao de 4: ");
    leituraPreOrdem(arvore);
    printf("\n");

    printf("Teste antes de remocao '10': \n");
    remocao(&arvore, 10);
    printf("Arvore apos remocao de 10: ");
    leituraPreOrdem(arvore);
    printf("\n");

    printf("Teste antes de remocao '2': \n");
    remocao(&arvore, 2);
    printf("Arvore apos remocao de 2: ");
    leituraPreOrdem(arvore);
    printf("\n");

    printf("Teste antes de remocao '6': \n");
    remocao(&arvore, 6);
    printf("Arvore apos remocao de 6: ");
    leituraPreOrdem(arvore);
    printf("\n");

    printf("Teste antes de remocao '5': \n");
    remocao(&arvore, 5);
